...
class _ReminderCardWidgetState extends State<ReminderCardWidget>
  ...
  (String, Color, String) _getCategoryInfo() {
    switch (widget.reminder.category.toLowerCase()) {
      case 'pill':
        return ('💊', AppTheme.categoryPill, 'medication');
      case 'food':
        return ('🍽️', AppTheme.categoryFood, 'restaurant');
      case 'appointment':
        return ('🏥', AppTheme.categoryAppointment, 'local_hospital');
      case 'calendar':
        return ('📅', AppTheme.categoryCalendar, 'event');
      case 'shopping':
        return ('🛒', AppTheme.categoryShopping, 'shopping_cart');
      default:
        return ('📋', AppTheme.categoryGeneral, 'list_alt');
    }
  }
      ...
      child: GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            border: _isOverdue
                ? Border.all(
                    color: AppTheme.errorRed.withAlpha(102),
                    width: 1.5,
                  )

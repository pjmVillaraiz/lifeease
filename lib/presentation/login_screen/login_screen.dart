...
class _LoginScreenState extends State<LoginScreen>
  ...
  // TODO: Replace with AuthViewModel (Riverpod/Bloc) for production
  ...
  Future<void> _signIn() async {
    ...
    // TODO: Replace with AuthViewModel.signInWithEmail(email, password) for production
    ...
    if (email == 'user@lifeease.ph' && password == 'LifeEase2025') {
  ...
  Future<void> _signInWithGoogle() async {
    HapticFeedback.mediumImpact();
    setState(() => _isLoading = true);
    // TODO: Replace with AuthViewModel.signInWithGoogle() via Supabase OAuth for production
  ...
  Future<void> _forgotPassword() async {
    ...
    // TODO: Replace with AuthViewModel.sendPasswordReset(email) for production
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  colors: [AppTheme.primaryBlue, Color(0xFF42A5F5)],
                ...
                boxShadow: [
                  BoxShadow(
                    color: AppTheme.primaryBlue.withAlpha(89),
                    blurRadius: 20,
                    offset: const Offset(0, 8),
                  ),
                ],
  ...
  Widget _buildFooterLinks(ThemeData theme) {
    return Row(
      ...
      children: [
        ...
        TextButton(
          onPressed: () {
            // TODO: Navigate to RegisterScreen when available
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
